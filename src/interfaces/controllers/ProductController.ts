...
export class ProductController {
  ...
  async list(req: Request, res: Response) {
    const page = parseInt(String(req.query.page || req.query.items || 1)) || 1;
    const limit = parseInt(String(req.query.limit || req.query.items || 10)) || 10;
  ...
  async search(req: Request, res: Response) {
    ...
    const fieldsParam = String(req.query.fields || '');
